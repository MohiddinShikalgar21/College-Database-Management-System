...
<html>
    <head>
        ...
        <title>This project is develope by Group SY32</title>
    </head>
    <body>
        <div class="panel panel-default">
			...
			<div class="container">
				<p style="text-align:center;">Group SY32</p>
                        </div><br><br>
                        
                        <h1><strong>Project title: </strong>College Management System</h1>
                        <h1><strong>Made by: </strong>Group SY32</h1>
                        <h1><strong>College: </strong>Vishwakarma Institute of Technology Pune.</h1>
