...
<div class="container_form">
	...
	<div style="margin-left: 150px;">
				<div class="teacher_name_pos" style="margin-left: 250px;">
				...
				<div class="teacher_radio_pos" style="margin-left: 215px;">
				    <span class="p_font" style="font-size: 17px;">Gender : </span>
					<input type="radio" name="genderrdo" value="Male" /> <span class="p_font" style="font-size: 17px;">&nbsp;Male</span>
					<input type="radio" name="genderrdo" value="Female" /> <span class="p_font" style="font-size: 17px;">&nbsp;Female</span>
				</div><br>
				
				<div class="teacher_bday_box" style="margin-left: 235px;">
					<span class="p_font" style="font-size: 17px;">Date of Birth: </span>&nbsp;&nbsp;&nbsp;
					<div class="select_style">
    					<select name="yy">
       						<option>Year</option>
       						<?php
				...
				<div class="teacher_degree_pos" style="margin-left: 320px;">
				    <span class="p_font" style="font-size: 17px; margin-top:-10px;">Qualifications : &nbsp;&nbsp;</span>
					<div class="select_style" style="border-left-width: 1px; margin-left: 0px; width: 212px; margin-right: 60px; margin-top: 0px; margin-bottom: 0px;">
    					<select name="degree">
       						<option>Degree</option>
       						<?php
                                $mm=array("Bachelor of Technology","Master of Technology","PHD");
                                $i=0;
                                foreach($mm as $mon){
                                    $i++;
				...
				<div class="teacher_married_pos">
					<span class="p_font" style="font-size: 17px;">Marital Status</span>
					<input type="radio" name="marriedrdo" value="Yes"/> <span class="p_font"  style="font-size: 17px;">&nbsp;Yes</span>
					<input type="radio" name="marriedrdo" value="No"/> <span class="p_font"  style="font-size: 17px;">&nbsp;No</span>
				</div><br>
